...
LOWEST_API_arm := 25
LOWEST_API_arm64 := 25
VARIANTS := assistant bromite calculator calendar chrome contacts deskclock dialer gboard gearhead launcher markup messages photos soundpicker tts vanced wellbeing
