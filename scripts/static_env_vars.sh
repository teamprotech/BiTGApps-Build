...
#
##############################################################
# File name       : statis_env_vars.sh
#
# Description     : Set static environmental variables
#
...
export TARGET_DPS_GOOGLE='"true"'
export TARGET_GBOARD_GOOGLE='"true"'
export TARGET_GEARHEAD_GOOGLE='"true"'
export TARGET_LAUNCHER_GOOGLE='"true"'
export TARGET_MAPS_GOOGLE='"true"'
...
export TARGET_TTS_GOOGLE='"true"'
export TARGET_VANCED_MICROG='"true"'
export TARGET_VANCED_ROOT='"true"'
export TARGET_VANCED_NONROOT='"true"'
