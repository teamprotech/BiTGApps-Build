  ...
  if [ "$COMMON" == "common" ]; then
    ...
    if [ "$SERVER" == "dh" ]; then
      if [ -n "$COMMONADDONRELEASE" ]; then
        ...
        $TARGET_VARIANT_DPS && curl -T out/common/BiTGApps-addon-dps-${COMMONADDONRELEASE}_signed.zip "ftp://${user}:${pass}@${host}/bitgapps.com/downloads/addon/non-config/BiTGApps-addon-dps-${COMMONADDONRELEASE}_signed.zip"
        ...
        $TARGET_VARIANT_MAPS && curl -T out/common/BiTGApps-addon-maps-${COMMONADDONRELEASE}_signed.zip "ftp://${user}:${pass}@${host}/bitgapps.com/downloads/addon/non-config/BiTGApps-addon-maps-${COMMONADDONRELEASE}_signed.zip"
