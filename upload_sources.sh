...
arm_sources() {
  if [ "$ARMEABI" == "arm" ]; then
    ...
    if [ "$SERVER" == "dh" ]; then
      if [ -n "$COMMONGAPPSRELEASE" ]; then
        $TARGET_API_31 && rsync -a -v out/arm/BiTGApps-arm-12.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm/S/BiTGApps-arm-12.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_30 && rsync -a -v out/arm/BiTGApps-arm-11.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm/R/BiTGApps-arm-11.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_29 && rsync -a -v out/arm/BiTGApps-arm-10.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm/Q/BiTGApps-arm-10.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_28 && rsync -a -v out/arm/BiTGApps-arm-9.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm/Pie/BiTGApps-arm-9.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_27 && rsync -a -v out/arm/BiTGApps-arm-8.1.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm/Oreo/BiTGApps-arm-8.1.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_26 && rsync -a -v out/arm/BiTGApps-arm-8.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm/Oreo/BiTGApps-arm-8.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_25 && rsync -a -v out/arm/BiTGApps-arm-7.1.2-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm/Nougat/BiTGApps-arm-7.1.2-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_25 && rsync -a -v out/arm/BiTGApps-arm-7.1.1-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm/Nougat/BiTGApps-arm-7.1.1-${COMMONGAPPSRELEASE}_signed.zip"
      fi
      if [ -n "$COMMONADDONRELEASE" ]; then
    ...
    if [ "$SERVER" == "sps" ]; then
      if [ -n "$COMMONGAPPSRELEASE" ]; then
        $TARGET_API_31 && rsync -a -v out/arm/BiTGApps-arm-12.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm/S/BiTGApps-arm-12.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_30 && rsync -a -v out/arm/BiTGApps-arm-11.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm/R/BiTGApps-arm-11.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_29 && rsync -a -v out/arm/BiTGApps-arm-10.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm/Q/BiTGApps-arm-10.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_28 && rsync -a -v out/arm/BiTGApps-arm-9.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm/Pie/BiTGApps-arm-9.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_27 && rsync -a -v out/arm/BiTGApps-arm-8.1.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm/Oreo/BiTGApps-arm-8.1.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_26 && rsync -a -v out/arm/BiTGApps-arm-8.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm/Oreo/BiTGApps-arm-8.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_25 && rsync -a -v out/arm/BiTGApps-arm-7.1.2-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm/Nougat/BiTGApps-arm-7.1.2-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_25 && rsync -a -v out/arm/BiTGApps-arm-7.1.1-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm/Nougat/BiTGApps-arm-7.1.1-${COMMONGAPPSRELEASE}_signed.zip"
      fi
      if [ -n "$COMMONADDONRELEASE" ]; then
...
arm64_sources() {
  if [ "$AARCH64" == "arm64" ]; then
    ...
    if [ "$SERVER" == "dh" ]; then
      if [ -n "$COMMONGAPPSRELEASE" ]; then
        $TARGET_API_31 && rsync -a -v out/arm64/BiTGApps-arm64-12.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm64/S/BiTGApps-arm64-12.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_30 && rsync -a -v out/arm64/BiTGApps-arm64-11.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm64/R/BiTGApps-arm64-11.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_29 && rsync -a -v out/arm64/BiTGApps-arm64-10.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm64/Q/BiTGApps-arm64-10.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_28 && rsync -a -v out/arm64/BiTGApps-arm64-9.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm64/Pie/BiTGApps-arm64-9.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_27 && rsync -a -v out/arm64/BiTGApps-arm64-8.1.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm64/Oreo/BiTGApps-arm64-8.1.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_26 && rsync -a -v out/arm64/BiTGApps-arm64-8.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm64/Oreo/BiTGApps-arm64-8.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_25 && rsync -a -v out/arm64/BiTGApps-arm64-7.1.2-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm64/Nougat/BiTGApps-arm64-7.1.2-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_25 && rsync -a -v out/arm64/BiTGApps-arm64-7.1.1-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/arm64/Nougat/BiTGApps-arm64-7.1.1-${COMMONGAPPSRELEASE}_signed.zip"
      fi
      if [ -n "$COMMONADDONRELEASE" ]; then
    ...
    if [ "$SERVER" == "sps" ]; then
      if [ -n "$COMMONGAPPSRELEASE" ]; then
        $TARGET_API_31 && rsync -a -v out/arm64/BiTGApps-arm64-12.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm64/S/BiTGApps-arm64-12.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_30 && rsync -a -v out/arm64/BiTGApps-arm64-11.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm64/R/BiTGApps-arm64-11.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_29 && rsync -a -v out/arm64/BiTGApps-arm64-10.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm64/Q/BiTGApps-arm64-10.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_28 && rsync -a -v out/arm64/BiTGApps-arm64-9.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm64/Pie/BiTGApps-arm64-9.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_27 && rsync -a -v out/arm64/BiTGApps-arm64-8.1.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm64/Oreo/BiTGApps-arm64-8.1.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_26 && rsync -a -v out/arm64/BiTGApps-arm64-8.0.0-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm64/Oreo/BiTGApps-arm64-8.0.0-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_25 && rsync -a -v out/arm64/BiTGApps-arm64-7.1.2-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm64/Nougat/BiTGApps-arm64-7.1.2-${COMMONGAPPSRELEASE}_signed.zip"
        $TARGET_API_25 && rsync -a -v out/arm64/BiTGApps-arm64-7.1.1-${COMMONGAPPSRELEASE}_signed.zip "${user}@${host}:/home2/hitman/sites/downloads/arm64/Nougat/BiTGApps-arm64-7.1.1-${COMMONGAPPSRELEASE}_signed.zip"
      fi
      if [ -n "$COMMONADDONRELEASE" ]; then
...
config_sources() {
  if [ "$CONFIG" == "config" ]; then
    ...
    if [ "$SERVER" == "dh" ]; then $BITGAPPS_CONFIG && rsync -a -v BiTGApps/config/bitgapps-config.prop "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/config/bitgapps-config.prop"; fi
    if [ "$SERVER" == "sps" ]; then $BITGAPPS_CONFIG && rsync -a -v BiTGApps/config/bitgapps-config.prop "${user}@${host}:/home2/hitman/sites/downloads/config/bitgapps-config.prop"; fi
  fi
}
...
apk_sources() {
  if [ "$APK" == "apk" ]; then
    ...
    if [ "$SERVER" == "dh" ]; then if [ -n "$APKRELEASE" ]; then rsync -a -v BiTGApps-v${APKRELEASE}.apk "${user}@${host}:/home/bitgapps/bitgapps.com/downloads/APK/BiTGApps-v${APKRELEASE}.apk"; fi; fi
    if [ "$SERVER" == "sps" ]; then if [ -n "$APKRELEASE" ]; then rsync -a -v BiTGApps-v${APKRELEASE}.apk "${user}@${host}:/home2/hitman/sites/downloads/APK/BiTGApps-v${APKRELEASE}.apk"; fi; fi
  fi
}
